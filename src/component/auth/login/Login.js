            ...
            <Box className="admin-login-main">
              <Box className="admin-login-inner">
                ...
                <Box className="flex-all forgot-row">
                  ...
                  <Link className="text-decoration-none admin-forgot-para common-para">
                    Forgot Password?
                  </Link>
                </Box>
                ...
                <Box className="or-text-main">
                  <Typography className="or-cocntent-text" component="p">
                    OR
                  </Typography>
                </Box>
                <AuthFooter />
                <Box className="condition-content">
                  <Typography className="condition-text">
                    {" "}
                    Don't have an account?{" "}
                    <span className="condition-span">
                      <Link className="condition-span">Sign Up here</Link>
                    </span>
                  </Typography>
                </Box>
              </Box>
